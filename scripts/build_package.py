...
def build_native():
    ...
    if platform.system().lower() == 'darwin':
        ...
        args = [compiler, '-std=c++17', '-fPIC', '-shared', '-I', include_root, '-I', jni_include, '-I', jni_platform, ROOT / 'src/main/native/processing_nozzle_jni.cpp', '-o', output]
        ...
        output = native_dir / native_name()
        args = ['cl', '/nologo', '/std:c++17', '/EHsc-', '/GR-', '/LD', '/I', include_root, '/I', jni_include, '/I', jni_platform, ROOT / 'src/main/native/processing_nozzle_jni.cpp', '/Fe:' + str(output)]
    else:
